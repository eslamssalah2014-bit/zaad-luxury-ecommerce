...
export const metadata: Metadata = {
  ...
  description: 'زاد (ZAAD) ليست مجرد متجر لبيع العسل، بل دار أصيلة لتوثيق النقاء الملكي، وأندر أعسال السدر الملكي والسمر الجبلي الموثقة بأعلى معايير الفخامة والأصالة.',
  keywords: ['عسل سدر ملكي', 'عسل فاخر', 'زاد', 'عسل طبيعي نقي', 'عسل سمر جبلي', 'فخامة هادئة', 'أعسال نادرة'],
  ...
  openGraph: {
    ...
    description: 'إرث من النقاء الطبيعي، مستخلص من أصفى المحميات والمناحل العذراء وفق أرقى معايير الجودة العالمية.',
