...
export async function PUT(request: NextRequest) {
  try {
    ...
    const updatePayload: any = {
      ...
      low_stock_threshold: Number(lowStockThreshold),
      weight_grams: Number(weightGrams),
      origin_region_ar: originRegionAr !== undefined ? (originRegionAr || null) : (existingProd?.origin_region_ar || null),
      origin_region_en: originRegionEn !== undefined ? (originRegionEn || null) : (existingProd?.origin_region_en || null),
