...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    يمر كل برطمان بعملية فلترة يدوية باردة ثلاثية المراحل دون أي تسخين أو معالجة حرارية للحفاظ على الإنزيمات الحية ومركبات الفلافونويد الفعالة. هذا الإصدار يخضع لفحص مخبري دولي مستقل يوثق خلوه التام من السكريات المضافة والمتبقيات الكيميائية.`,
    healthBenefitsAr: [
  ...
  },
  {
    ...
    تتضمن المجموعة شهادة أصالة موقعة تتضمن أرقام التشغيلات ونتائج الفحص المخبري لكل صنف لضمان تجربة إهداء تليق بالمقام.`,
    healthBenefitsAr: [
...
export const INITIAL_ORDERS: Order[] = [
  ...
  },
  {
    ...
    courierName: 'سمسا إكسبريس (شحن مبرد فاخر)',
    statusTimeline: [
...
export const INITIAL_AUDIT_LOGS: AuditLog[] = [
  ...
  },
  {
    ...
    detailsAr: 'تسجيل نتائج الفحص المخبري الأوروبي لتشغيلة السدر الملكي (رطوبة 14.2%، نقاء لقاح 98.6%).',
    ipAddress: '192.168.1.10',
